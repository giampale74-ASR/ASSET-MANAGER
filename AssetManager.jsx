...
export default function AssetManager() {
  ...
  const saveForm = async () => {
    ...
    const payload = { nominativo:form.nominativo,email:form.email,reparto:form.reparto,serialePC:form.serialePC,modelloPC:form.modelloPC,dataAcquisto:form.dataAcquisto,dataConsegna:form.dataConsegna,sim:form.sim,numeroCellulare:form.numeroCellulare,accountMicrosoft:form.accountMicrosoft,note:form.note,stato:form.stato };
    try {
      if (editId) {
